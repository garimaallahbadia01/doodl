...
Navigate to `http://localhost:3000` (or whatever specific port the terminal provides) to see Air Canvas V3 running. Ensure you are well lit with a clear view of your hands in the PIP.
